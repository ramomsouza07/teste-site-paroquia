...
// Lembre-se de importar as imagens reais da Sagrada Família
// Usando a foto que você mostrou antes da faixada
import imgFachada from '../../assets/sagrada_familia/sagrada_familia.png'; 
import imgInterior from '../../assets/sagrada_familia/sagrada_familia_1.jpg'; // Substitua pela foto do interior
import imgExtra from '../../assets/sagrada_familia/sagrada_familia_imagem.jpg';    // Substitua por uma terceira foto, se tiver
            ...
            <main className="bg-branco-amarelado min-h-screen pb-[80px]">
                ...
                <section className="bg-gradient-to-b from-marrom-escuro to-marrom-claro py-[80px] px-[20px] text-center shadow-md">
                    ...
                    <p className="text-branco-amarelado text-[18px] md:text-[22px] max-w-[800px] mx-auto">
                        Lugar de encontro com Deus, onde vivemos a fé, o amor e a união em comunidade, a exemplo de Jesus, Maria e José.
                    </p>
                </section>
                ...
                <section className="max-w-[900px] mx-auto px-[20px] mt-[60px]">
                    ...
                    <div className="mt-[30px] w-full bg-branco rounded-[10px] shadow-[0_4px_10px_rgba(0,0,0,0.05)] border-t-[4px] border-marrom-claro overflow-hidden">
                        {/* Lembre-se de trocar esse src pelo link real do Google Maps da Sagrada Família */}
                        <iframe 
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4675.063525606048!2d-41.74032920560867!3d-21.64132604456624!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xbdb238c8e3000b%3A0xe0a9de51bc34f980!2sIgreja%20Sagrada%20Fam%C3%ADlia!5e0!3m2!1spt-BR!2sbr!4v1774113543997!5m2!1spt-BR!2sbr" 
                            className="w-full h-[350px] md:h-[450px]" 
                            style={{ border: 0 }} 
                            allowFullScreen 
                            loading="lazy" 
                            referrerPolicy="no-referrer-when-downgrade"
                            title="Mapa de localização da Capela Sagrada Família"                            
                        ></iframe>
                    </div>
                ...
                <section className="max-w-[1000px] mx-auto px-[20px] mt-[40px] mb-[40px]">
                    <div className="bg-branco p-[30px] md:p-[40px] rounded-[10px] shadow-[0_4px_10px_rgba(0,0,0,0.05)] border-t-[4px] border-marrom-claro text-center">
                        ...
                        {/* Grid de Fotos mantendo o padrão da quebra (a 1ª foto ocupa 2 colunas) */}
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-[20px] mb-[40px]">
                            
                            <img 
                                src={imgFachada} 
                                alt="Fachada da Capela Sagrada Família" 
                            ...
                            <img 
                                src={imgInterior} 
                                alt="Interior da Capela Sagrada Família" 
                        ...
                        <div className="border-t border-marrom-claro/30 pt-[30px]">
                            <h2 className="text-marrom-escuro text-[24px] md:text-[28px] font-bold italic font-serif leading-relaxed">
                                "Jesus, Maria e José, nossa família vossa é!" <br/>
