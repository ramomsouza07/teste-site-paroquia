    ...
    return (
        <header className="bg-[#331905] text-white p-0 sticky top-0 z-[1000] w-full">
            ...
            <div className="max-w-[1400px] h-[100px] mx-auto px-5 grid grid-cols-[1fr_auto] min-[768px]:grid-cols-[1fr_auto_1fr] items-center">
                ...
                {/* 2. Menu Central (Visível apenas acima de 768px) */}
                <nav className="hidden min-[768px]:flex items-center justify-self-center">
                    <ul className="list-none flex items-center gap-[30px] m-0 p-0">
                        <li><a href="/" className="text-[16px] font-medium text-white transition-all duration-300 py-[5px] hover:[text-shadow:0px_4px_12px_rgba(255,255,255,0.6)]">Home</a></li>
                        <li><a href="#comunidades" className="text-[16px] font-medium text-white transition-all duration-300 py-[5px] hover:[text-shadow:0px_4px_12px_rgba(255,255,255,0.6)]">Nossas Igrejas</a></li>
                        <li><a href="#dizimo" className="text-[16px] font-medium text-white transition-all duration-300 py-[5px] hover:[text-shadow:0px_4px_12px_rgba(255,255,255,0.6)]">Dízimo</a></li>
                        <li><a href="" className="text-[16px] font-medium text-white transition-all duration-300 py-[5px] hover:[text-shadow:0px_4px_12px_rgba(255,255,255,0.6)]">Serviços</a></li>
                        <li><a href="/contatos" className="text-[16px] font-medium text-white transition-all duration-300 py-[5px] hover:[text-shadow:0px_4px_12px_rgba(255,255,255,0.6)]">Contato</a></li>
                    </ul>
                </nav>

                {/* 3. Redes Sociais (Visível apenas acima de 768px) */}
                ...
                {/* 4. Botão Mobile (Escondido acima de 768px) */}
            ...
            {/* 5. MENU MOBILE DROPDOWN (Escondido acima de 768px) */}
            <div className={`min-[768px]:hidden w-full bg-[#331905] border-t border-[#A48267] overflow-hidden transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-[400px] py-5' : 'max-h-0'}`}>
                <ul className="flex flex-col items-center gap-5 m-0 p-0 list-none">
                    <li><a href="/" onClick={toggleMenu} className="text-[18px] font-medium text-white">Home</a></li>
                    <li><a href="#comunidades" onClick={toggleMenu} className="text-[18px] font-medium text-white">Nossas Igrejas</a></li>
                    <li><a href="#dizimo" onClick={toggleMenu} className="text-[18px] font-medium text-white">Dízimo</a></li>
                    <li><a href="" onClick={toggleMenu} className="text-[18px] font-medium text-white">Serviços</a></li>
                    <li><a href="/contatos" onClick={toggleMenu} className="text-[18px] font-medium text-white">Contato</a></li>
